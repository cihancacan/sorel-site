...
export const servicesFr: Service[] = [
  ...
  description: 'SOREL conçoit et produit des formats audiovisuels premium pour studios podcast, émissions, interviews, courts-métrages et tournages de film. Une direction visuelle exigeante, une exécution fluide et une signature haut de gamme pour vos productions éditoriales, corporate et artistiques.',
  heroLine: 'Podcasts, émissions et productions audiovisuelles avec une signature premium.',
  type: 'photo-video',
},
{
  slug: 'studio-podcast',
  title: 'Studio Podcast',
  shortTitle: 'Studio Podcast',
  category: 'studio-production',
  description: 'Tournage de podcast en studio avec image premium, cadrage soigné, lumière maîtrisée et restitution prête à diffuser sur vos plateformes.',
  heroLine: 'Le podcast filmé, porté par une image haut de gamme.',
  type: 'photo-video',
},
{
  slug: 'tournage-emission',
  title: 'Tournage d’Émission',
  shortTitle: 'Tournage Émission',
  category: 'studio-production',
  description: 'Captation et production d’émissions, formats éditoriaux, interviews et épisodes récurrents avec une exécution rigoureuse et un rendu premium.',
  heroLine: 'Des formats éditoriaux fluides, élégants et prêts à être diffusés.',
  type: 'photo-video',
},
{
  slug: 'interview-captation',
  title: 'Interview & Captation',
  shortTitle: 'Interview & Captation',
  category: 'studio-production',
  description: 'Interviews, prises de parole, contenus experts et captations multi-caméras réalisés avec précision pour vos besoins corporate, média ou institutionnels.',
  heroLine: 'Une parole forte mérite une réalisation irréprochable.',
  type: 'photo-video',
},
{
  slug: 'tournage-court-metrage',
  title: 'Tournage de Court-Métrage',
  shortTitle: 'Court-Métrage',
  category: 'studio-production',
  description: 'Accompagnement visuel et tournage de courts-métrages avec sens du cadre, rythme cinématographique et exigence de production.',
  heroLine: 'L’exigence visuelle du court-métrage, avec la signature SOREL.',
  type: 'photo-video',
},
{
  slug: 'tournage-film',
  title: 'Tournage de Film',
  shortTitle: 'Tournage Film',
  category: 'studio-production',
  description: 'Production d’images et tournage de film avec direction visuelle premium, coordination précise et rendu à la hauteur des projets ambitieux.',
  heroLine: 'Une production maîtrisée pour des images fortes et durables.',
  type: 'photo-video',
},
  {
