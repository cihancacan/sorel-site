    ...
    ? [
        {
          ...
          featured: false,
          href: `/${locale}/${isFr ? 'reserver' : 'book'}?service=photo-video-mariage&mediaType=both&pack=essentielle`,
        },
        {
          ...
          featured: true,
          href: `/${locale}/${isFr ? 'reserver' : 'book'}?service=photo-video-mariage&mediaType=both&pack=signature`,
        },
        {
          ...
          featured: false,
          href: `/${locale}/${isFr ? 'reserver' : 'book'}?service=photo-video-mariage&mediaType=both&pack=maison`,
        },
      ]
    : [
        {
          ...
          featured: false,
          href: `/${locale}/${isFr ? 'reserver' : 'book'}?service=photo-video-mariage&mediaType=both&pack=essential`,
        },
        {
